...
@Named
@Singleton
public class ClimateServiceController extends Controller implements Retrieve, Create, Update {
	...
	public Result getAll(String format) {
		...
		System.out.println("Retrieve all objects from climate service: " + result.toString());
		return ok(result);

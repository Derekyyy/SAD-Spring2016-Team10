...
public class CommentController extends Controller {
    ...
    public Result addReply() {
        ...
        // Mediator Pattern
//        ReplyDisplay rd = new ReplyDisplay();
        ReplyDisplay.showReply(fromUser, toUser, reply);
...
//        public void showReply(User user, Reply reply){
//            System.out.println("****************" + new Date().toString() + " [" + user.getUserName() + "] : " + reply.getContent());
//        }
//    }
}

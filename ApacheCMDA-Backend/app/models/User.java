...
public class User {
	...
	@JoinTable(	name = "blacklist",
			joinColumns = { @JoinColumn(name ="userId", referencedColumnName = "id")},
			inverseJoinColumns = { @JoinColumn(name = "blackId", referencedColumnName = "id") })
	protected Set<User> blackList;
...
//	private String highestDegree;
	...
	public void addToBlackList(User blackUser) {
		this.blackList.add(blackUser);
	}

	public void deleteFromBlackList(User blackUser) {
		this.blackList.remove(blackUser);
	}
